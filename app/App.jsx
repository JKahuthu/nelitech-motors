  ...
  return (
    <main className="p-4 md:p-10 space-y-10">
      ...
      <section className="grid md:grid-cols-3 gap-6">
        {vehicles.map((car) => (
          <div key={car.id} className="rounded-2xl shadow-md border overflow-hidden">
            ...
            <div className="p-4 space-y-2">
              ...
              <div className="flex gap-2">
                <button className="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700">Enquire</button>
                <button className="w-full border py-2 rounded hover:bg-gray-100">Book</button>
              </div>
            </div>
          </div>
        ))}
      ...
      <section className="bg-gray-100 p-6 rounded-xl text-center">
        ...
        >
          <button className="mt-4 bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 flex items-center justify-center">
